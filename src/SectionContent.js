      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            width: '10px',
            height: '10px',
            background: 'radial-gradient(circle, #00B7EB, #000)', // Blue orb influence
            borderRadius: '50%'
          }} />
          <div style={{
            position: 'absolute',
        ...
        <div style={{
          ...
          fontSize: '0.9rem',
          textShadow: '0 0 3px #00B7EB' // Softer blue shadow
        }}>
          ...
          <div key={index} style={{
            ...
            {item.artist && (
              <div style={{
                ...
                marginBottom: '8px',
                textShadow: '0 0 2px #00B7EB' // Softer blue shadow
              }}>
                by {item.artist}
              </div>
            )}
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span>SECTOR: </span>
            <span style={{ color: '#FFFFFF' }}>{section.id?.toUpperCase()}</span>
          </div>
